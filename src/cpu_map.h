...
//  #define STEP_BIT_2 3  // Z Step - Pin D46
  /** FM **/
  #define STEP_BIT_0 0  // X Step - Pin A0
  #define STEP_BIT_1 3  // Y Step - Pin D46
  #define STEP_BIT_2 6  // Z Step - Pin A6
...
//  #define DIRECTION_BIT_2 1 // Z Dir - Pin D48
  /** FM **/
  #define DIRECTION_BIT_0 1 // X Dir - Pin A1
  #define DIRECTION_BIT_1 1 // Y Dir - Pin D48
  #define DIRECTION_BIT_2 7 // Z Dir - Pin A7
  #if N_AXIS > 3
...
//  #define STEPPER_DISABLE_PORT_2 K
  /** FM **/
  #define STEPPER_DISABLE_PORT_0 D
  #define STEPPER_DISABLE_PORT_1 K
  #define STEPPER_DISABLE_PORT_2 F
...
//  #define STEPPER_DISABLE_BIT_2 0 // Z Enable - Pin A8
  /** FM **/
  #define STEPPER_DISABLE_BIT_0 7 // X Enable - Pin D38
  #define STEPPER_DISABLE_BIT_1 0 // Y Enable - Pin A8
  #define STEPPER_DISABLE_BIT_2 2 // Z Enable - Pin A2
  #if N_AXIS > 3
...
//  #define MIN_LIMIT_PORT_2 D
  /** FM **/
  #define MIN_LIMIT_PORT_0 E
  #define MIN_LIMIT_PORT_1 D
  #define MIN_LIMIT_PORT_2 J
  #if N_AXIS > 3
...
//  #define MIN_LIMIT_BIT_2 3 // Z Limit Min - Pin D18
  /** FM **/
  #define MIN_LIMIT_BIT_0 5 // X Limit Min - Pin D3
  #define MIN_LIMIT_BIT_1 3 // Y Limit Min - Pin D18
  #define MIN_LIMIT_BIT_2 1 // Z Limit Min - Pin D14
  #if N_AXIS > 3
...
//  #define MAX_LIMIT_BIT_2 2 // Z Limit Max - Pin D19
  /** FM **/
  #define MAX_LIMIT_BIT_0 4 // X Limit Max - Pin D2
  #define MAX_LIMIT_BIT_1 2 // Y Limit Max - Pin D19
  #define MAX_LIMIT_BIT_2 0 // Z Limit Max - Pin D15
  #if N_AXIS > 3
  ...
  #define SPINDLE_ENABLE_BIT      4 // MEGA2560 Digital Pin 10 - Ramps 1.4 Servo 4 Signal pin (D10)
...
//  #define COOLANT_FLOOD_BIT   4 // MEGA2560 Digital Pin 10 - Ramps 1.4 12v output (D10)
  /** FM **/
  #define COOLANT_FLOOD_DDR   DDRG
  #define COOLANT_FLOOD_PORT  PORTG
  #define COOLANT_FLOOD_BIT   5 // MEGA2560 Digital Pin 4 - Ramps 1.4 12v output (D4)
  #define COOLANT_MIST_DDR    DDRH
  #define COOLANT_MIST_PORT   PORTH
  #define COOLANT_MIST_BIT    6 // MEGA2560 Digital Pin 9 - Ramps 1.4 12v output (D9)
  ...
  #define PROBE_BIT       2  // MEGA2560 D35
  #define PROBE_MASK      (1<<PROBE_BIT)
/*
  // Advanced Configuration Below You should not need to touch these variables
  ...
  #define SPINDLE_PWM_DDR   DDRH
  #define SPINDLE_PWM_PORT  PORTH
  #define SPINDLE_PWM_BIT   5 // MEGA2560 Digital Pin 8 (D8)
*/
...
/** FM **/
  ...
  #define SPINDLE_PWM_DDR   DDRH
  #define SPINDLE_PWM_PORT  PORTH
  #define SPINDLE_PWM_BIT   3 // MEGA2560 Digital Pin 6 (D6)
